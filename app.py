...
def main():
    st.markdown("<h1 style='text-align: center;'>Megaprosthesis Survival Prediction</h1>", unsafe_allow_html=True)
    st.markdown("<h1 style='text-align: center;'>12 months</h1>", unsafe_allow_html=True)
